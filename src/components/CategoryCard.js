...
const CategoryCard = ({ image, title, price, descr, quantity, qty, amount, time, available = true, size = 1, gapV = 20, gapH = 20 }) => {
  ...
  const { addedToCart, removedFromCart, toggleFavoriteItem, isFavorite, cartItems, setCartItems, setFavItems, fetchFavorites, fetchProductByTitle, onAddtoCart } = useCart();
