...
const ProductScreen = () => {
  ...
  const { image, title, price, onAddtoCart } = route.params;
...
const dynamicTheme = (theme) => ({
  ...
  productTitle: { fontSize: 22, fontWeight: "bold", color: theme.text, marginLeft: 20, width: '50%', backgroundColor: 'transparent' },
  productPrice: { fontSize: 22, color: theme.cardPrice, marginTop: 10, marginLeft: 20, fontWeight: 'bold' },
